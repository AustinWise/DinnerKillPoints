...
using MultiCreditorDebtList = System.Collections.Generic.List<(Austin.DkpLib.Person debtor, System.Collections.Generic.List<(Austin.DkpLib.Person creditor, double amount)> debts)>;
